...
class GendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gender" do
    assert_difference('Gender.count') do
      post genders_url, params: { gender: { gender: @gender.gender, genderCode: @gender.genderCode } }
    end
  ...
  test "should update gender" do
    patch gender_url(@gender), params: { gender: { gender: @gender.gender, genderCode: @gender.genderCode } }
