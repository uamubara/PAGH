...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { stateCode: @state.stateCode, stateName: @state.stateName } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { stateCode: @state.stateCode, stateName: @state.stateName } }
