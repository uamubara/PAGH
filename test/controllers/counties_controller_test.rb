...
class CountiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create county" do
    assert_difference('County.count') do
      post counties_url, params: { county: { county: @county.county, state_id: @county.state_id } }
    end
  ...
  test "should update county" do
    patch county_url(@county), params: { county: { county: @county.county, state_id: @county.state_id } }
