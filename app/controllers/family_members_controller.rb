class FamilyMembersController < ApplicationController
  ...
  private
    ...
    def family_member_params
      params.require(:family_member).permit(:member_id, :relationship_id, :title, :first_name, :middle_initial, :last_name, :birthdate, :age, :gender_id, :email, :home_phone, :cell_phone)
    end
end
