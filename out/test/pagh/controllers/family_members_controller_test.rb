...
class FamilyMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family_member" do
    assert_difference('FamilyMember.count') do
      post family_members_url, params: { family_member: { age: @family_member.age, birthdate: @family_member.birthdate, cell_phone: @family_member.cell_phone, email: @family_member.email, first_name: @family_member.first_name, gender_id: @family_member.gender_id, home_phone: @family_member.home_phone, last_name: @family_member.last_name, member_id: @family_member.member_id, middle_initial: @family_member.middle_initial, relationship_id: @family_member.relationship_id, title: @family_member.title } }
    end
  ...
  test "should update family_member" do
    patch family_member_url(@family_member), params: { family_member: { age: @family_member.age, birthdate: @family_member.birthdate, cell_phone: @family_member.cell_phone, email: @family_member.email, first_name: @family_member.first_name, gender_id: @family_member.gender_id, home_phone: @family_member.home_phone, last_name: @family_member.last_name, member_id: @family_member.member_id, middle_initial: @family_member.middle_initial, relationship_id: @family_member.relationship_id, title: @family_member.title } }
